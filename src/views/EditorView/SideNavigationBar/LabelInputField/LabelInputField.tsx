...
class LabelInputField extends React.Component<IProps, IState> {
    ...
    private dropdownOptionCount: number = 8
    ...
    private openDropdown = (event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    ...
    private getDropdownOptions = () => {
        ...
        return this.props.options.map((option: LabelName) => {
            return (
                ...
                >
                    <span
                        className='DropdownOptionMarker'
                        style={{backgroundColor: option.color}}
                    />
                    <span className='DropdownOptionName'>
    ...
    private onClickHandler = (event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
        event.stopPropagation()
        this.props.updateActiveLabelId(this.props.id)
    }
